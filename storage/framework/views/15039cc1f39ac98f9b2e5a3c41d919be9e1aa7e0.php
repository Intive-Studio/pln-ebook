...
<body style="overflow: hidden">
    ...
    <div class="container-fluid" style="height: 100vh; width: 100vw;">
                ...
                <div id="katalog" class="buku">
                    <?php for($i = 1; $i <= 98; $i++): ?>
                        <div id="p<?php echo e($i); ?>">
                            <?php if($i == 1): ?>
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/a3KriqTgaQE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            <?php endif; ?>
                        </div>
                    <?php endfor; ?>
                </div>
        ...
        <div id="navigation2" class="container">
            <div class="row mg-bottom-10 mg-top-15">
                <div class="col-md-12 text-center">
                    <a target="_blank" href="<?php echo e(asset('e-catalog/katalog.pdf')); ?>" class="btn btn-primary"><i class="fa fa-download"></i></a>
                    <button class="btn btn-primary cov">
                        <i class="fa fa-angle-double-left"></i>
                    </button>
                    <button class="btn btn-primary prev">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/rumah-batik/resources/views/katalog.blade.php ENDPATH**/ ?>